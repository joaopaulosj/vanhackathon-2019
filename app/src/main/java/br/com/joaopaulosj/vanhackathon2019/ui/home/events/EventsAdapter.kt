...
class EventsAdapter(context: Context, private val onItemClickListener: OnItemClickListener) :
    ...
    interface OnItemClickListener {
        ...
        fun onCalendarClicked(item: EventResponse)
    }
        ...
        fun bind(item: EventResponse, onItemClickListener: OnItemClickListener) {
            itemView.apply {
                ...
                if (item.applied) {
                    ...
                    itemEventButtonTv.setTextColor(
                ...
                itemEventCalendarBtn.setOnClickListener {
                    onItemClickListener.onCalendarClicked(item)
                }
