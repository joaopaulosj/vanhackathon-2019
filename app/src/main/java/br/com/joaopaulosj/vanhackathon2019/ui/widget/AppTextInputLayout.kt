package br.com.joaopaulosj.vanhackathon2019.ui.widget
...
import br.com.joaopaulosj.vanhackathon2019.utils.insertMask
import br.com.joaopaulosj.vanhackathon2019.utils.validations.IsCnpj
import br.com.joaopaulosj.vanhackathon2019.utils.validations.IsCpf
...
class AppTextInputLayout : TextInputLayout {
    ...
    fun setParams(inputTextType: Int, hint: String?, emptinessValid: Boolean, minLength: Int) {
        ...
        if (emptyErrorText.isNullOrEmpty())
            emptyErrorText = context.getString(R.string.apptextinputlayout_empty_field, getHint().toString())
    }
